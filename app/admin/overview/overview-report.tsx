  ...
  if (!data || isPending)
    return (
      <div className='space-y-4'>
        <div>
          <h1 className='h1-bold'>Главная</h1>
        </div>
        {/* First Row */}
    ...
    <div>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          <Card>
            <CardHeader>
              <CardTitle>Сколько вы зарабатываете</CardTitle>
              <CardDescription>
              Оценка · Последние 6 месяцев
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Характеристики продукта</CardTitle>
              <CardDescription>
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          <Card>
            <CardHeader>
              <CardTitle>Категории бестселлеров</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <TableBody>
                  {data.latestOrders.map((order: IOrderList) => (
                    <TableRow key={order._id}>
                      <TableCell>
                        {order.user ? order.user.name : 'Удалить пользователя' }
                      </TableCell>
