...
export default function ReviewList({
  ...
  const reload = async () => {
    try {
      ...
      toast({
        variant: "destructive",
        description: "Ошибка при получении отзывов",
      });
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-3 flex flex-col gap-3">
              ...
              <CardHeader>
                <div className="flex-between">
                  ...
                  <div className="italic text-sm flex">
                    <Check className="h-4 w-4" /> Проверенная покупка
                  </div>
                </div>
              ...
              <CardContent>
                <div className="flex space-x-4 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center">
                    ...
                    {review.user ? review.user.name : "Удалить пользователя"}
                  </div>
                  <div className="flex items-center">
          ...
          <div ref={ref}>
            ...
            {page < totalPages && loadingReviews && "Загрузка"}
          </div>
        </div>
      </div>
    </div>
